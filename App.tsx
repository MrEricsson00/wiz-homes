        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="col-span-1 md:col-span-2 space-y-8">
            ...
            <div className="flex space-x-4">
               <a href="https://www.instagram.com/wiz.homes?igsh=MWc5ZXJpeTl3Ym5weA%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-zinc-900/50 rounded-2xl flex items-center justify-center hover:bg-red-600 transition-all cursor-pointer border border-zinc-800 group">
                 <span className="text-[10px] font-black uppercase group-hover:scale-110 transition-transform">IG</span>
               </a>
               <a href="https://www.tiktok.com/@wiz_homes?_r=1&_t=ZS-94ERKn0elXt" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-zinc-900/50 rounded-2xl flex items-center justify-center hover:bg-red-600 transition-all cursor-pointer border border-zinc-800 group">
                 <span className="text-[10px] font-black uppercase group-hover:scale-110 transition-transform">TT</span>
               </a>
            </div>
          </div>
          <div>
          ...
          <div>
            <h4 className="text-xs font-black uppercase tracking-[0.4em] text-white mb-8">Location</h4>
            <ul className="space-y-4 text-[11px] font-black uppercase tracking-widest text-zinc-500">
              <li><a href="https://maps.app.goo.gl/9P8JnJdUdpJ51Jtp6?g_st=ic" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors">View on Google Maps</a></li>
              <li className="text-red-600">info@wizhomes.com</li>
            </ul>
          </div>
        </div>
